...
import { PackagePlus, Plus, Save, Store, Trash2, UserRoundPlus } from 'lucide-react';
...
const QuickSalesGrid: React.FC = () => {
    ...
    const createVendor = async () => {
        ...
        try {
            ...
            setMessage(`${response.data.name} created. Record vendor stock before selling.`);
    ...
    const receiveStock = async () => {
        ...
        try {
            ...
            setMessage('Vendor stock received. The vendor now appears in the available-stock dropdown.');
